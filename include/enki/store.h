...
enki_error enki_store_read(enki_store* store, const uint8_t* key_b, uint8_t* bytes_b,
    size_t cap_s, size_t* len_s);
enki_error enki_store_write(enki_store* store, const uint8_t* key_b, const uint8_t* bytes_b,
    size_t len_s);
