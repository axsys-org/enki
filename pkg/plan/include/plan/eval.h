...
/* Abandon a stopped computation (PL_RUN_BLOCKED or PL_RUN_YIELDED) and unwind
 * its stacks and run-local profiling zones to the entry watermarks.  The
 * thread must be re-armed with pl_thread_start before it can run again. */
